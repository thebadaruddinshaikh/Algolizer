...
;define("algolizer/controllers/pathfinding/index", ["exports", "@ember/controller", "@ember/object", "@glimmer/tracking", "@ember/service"], function (_exports, _controller, _object, _tracking, _service) {
  ...
  let PathfindingIndexController = (_dec = (0, _service.inject)('drag-state'), (_class = class PathfindingIndexController extends _controller.default {
    ...
    randomVisit() {
      ...
      this.updateWithRebuild(x, y, false, true);
    }
  ...
  }), _applyDecoratedDescriptor(_class.prototype, "onChangeHandler", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "onChangeHandler"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "randomVisit", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "randomVisit"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "find", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "find"), _class.prototype)), _class));
...
;
          if (!runningTests) {
            require("algolizer/app")["default"].create({"name":"algolizer","version":"0.0.0+f529a9e0"});
          }
