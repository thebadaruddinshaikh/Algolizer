...
if(!n&&t.type&&r.type!==x(t.type)){var a=o.assign({},t)
delete a.lid,n=this.getOrCreateRecordIdentifier(a)}if(n){var s=J(this._cache.types,r.type)
...
r===ue&&(a="Invalid Document",o="/data"),t.push({title:a,detail:i[n],source:{pointer:o}})}})),t}function de(e){var t={}
return a.isPresent(e)&&e.forEach((e=>{if(e.source&&e.source.pointer){var r=e.source.pointer.match(oe)
...
return Object.keys(this._store._attributesDefinitionFor(this.modelName,this.identifier)).forEach((r=>{!0===this.type.isModel?t[r]=n.get(e,r):t[r]=ve(this._internalModel).getAttr(r)})),t}get type(){return this._internalModel.modelClass}get isNew(){return this._internalModel.isNew()}attr(e){if(e in this._attributes)return this._attributes[e]}attributes(){return o.assign({},this._attributes)}changedAttributes(){var e=Object.create(null)
...
return(u=Re(u,t,c)).then((e=>we(t.serializerFor(r),t,o,e,null,"findMany")),null,`DS: Extract payload of ${r}`)}_processCoalescedGroup(e,t,r,i,n){for(var a=t.length,s=new Array(a),o=new Array(a),l=0;l<a;l++)o[l]=t[l],s[l]=o[l].id
var u=this._store
...
h[p]=new ge(f,a[p],this._store)}for(var m=0,v=(d=r.groupRecordsForFindMany?r.groupRecordsForFindMany(this,h):[h]).length;m<v;m++)this._processCoalescedGroup(s,d[m],r,o,t)}else for(var g=0;g<n;g++)this._fetchRecord(e[g])}getPendingFetch(e,t){var r=this.requestCache.getPendingRequestsForRecord(e).filter((e=>"query"===e.type&&function(e,t){void 0===e&&(e={})
void 0===t&&(t={})
return e.include===t.include}(t,e.request.data[0].options)))
if(r.length>0)return r[0][pe]}flushAllPendingFetches(){this.isDestroyed||(this._pendingFetch.forEach(this._flushPendingFetchForType,this),this._pendingFetch.clear())}destroy(){this.isDestroyed=!0}}var Te=k.default
...
t&&t.delete(this)}))},_pushIdentifiers(e){n.get(this,"content").pushObjects(e)},_removeIdentifiers(e){n.get(this,"content").removeObjects(e)},_takeSnapshot(){return n.get(this,"content").map((e=>De(this.store).lookup(e).createSnapshot()))}}),Fe=Ie.extend({init(){this.set("content",this.get("content")||s.A()),this._super(...arguments),this.query=this.query||null,this.links=this.links||null},replace(){throw new Error(`The result of a server query (on ${this.modelName}) is immutable.`)},_update(){var e=n.get(this,"store"),t=n.get(this,"query")
...
Ue(this.store,n)&&r.push(n)}return r}createRecordArray(e,t){var r=Ie.create({modelName:e,content:s.A(t||[]),store:this.store,isLoaded:!0,manager:this})
...
return t._push(i)}),null,`DS: Extract payload of ${r}`)}function Lt(e,t,r,i){var n,a,s=t.data?(n=t.data,a=(t,n)=>{var{id:a,type:s}=t
...
return ie(p.all(r).then(s.A,null,`DS: Store#findByIds of ${i} complete`))}_fetchRecord(e,t){var r=e.modelName
...
r[i]=n}return n}e.AdapterPopulatedRecordArray=Fe,e.DeprecatedEvented=Te,e.InternalModel=Ot,e.PromiseArray=ee,e.PromiseObject=te,e.RecordArray=Ie,e.RecordArrayManager=$e,e.RecordDataStoreWrapper=Ut,e.RootState=vt,e.Snapshot=ge,e.SnapshotRecordArray=Pe,e.Store=class extends qt{constructor(){super(...arguments),this._modelFactoryCache=Object.create(null),this._relationshipsDefCache=Object.create(null),this._attributesDefCache=Object.create(null)}instantiateRecord(e,r,i,n){var a=e.type,s={store:this,_internalModel:this._internalModelForResource(e),_createProps:r,container:null}
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default="3.28.8"})),define("ember-fetch/errors",["exports"],(function(e){"use strict"
